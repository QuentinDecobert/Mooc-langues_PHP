...
<div id="container" class="quiz with-menu">
  <div class="row">
    <div class="col-md-12 col-md-offset-1">
      <h2 style="margin-top:2%;">Résultats du Quiz :</h2>
      <?php
      $x = 1;
      ...
      foreach ($quiz->getAllAnswersGroupedByQuestion() as $answergroup) :
        ...
        foreach( $answergroup as $answer) :
          if (isset($_SESSION['correct'][$x])):
            ...
            <div class="row" id="final_score">
              <div class="table">
                <div class="table-cell">
                  <ul class="leaders col-md-12">
                      <h2 style="text-align:center;margin-top:10%;">Meilleurs score</h2>
                    <?php
                    ...
                    foreach ($leaders as $leader) :
                      ...
                      echo '<li><h3>' . $name. ': ' .  $percentage . '%</h3></li>';
